...
class SlimDoubleConv(nn.Module):
    def __init__(self, in_ch, out_ch, mid_ch=None, p_drop=0.05):
        super().__init__()
...
class MediumPoseUNet(nn.Module):
    def __init__(self, in_ch, n_kpts):
        super().__init__()
        self.inc   = SlimDoubleConv(in_ch, 48)
        ...
        self.up3 = Up(192, 96)
        self.up4 = Up(96, 48)
        self.outc = nn.Conv2d(48, n_kpts, kernel_size=1)
